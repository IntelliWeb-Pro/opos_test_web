...
# Creamos una clase para mejorar la vista en el admin
class PostAdmin(admin.ModelAdmin):
    list_display = ('titulo', 'slug', 'autor', 'estado', 'creado_en')
    list_filter = ('estado', 'creado_en')
    search_fields = ('titulo', 'contenido')
    prepopulated_fields = {'slug': ('titulo',)} # Autogenera la URL amigable a partir del título
...
admin.site.register(Post, PostAdmin) # <-- AÑADE ESTA LÍNEA
